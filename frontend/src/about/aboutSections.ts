...
export const helpQuickLinks = [
  ...
  { label: "后台管理", articleId: "admin-management" },
];
...
export const helpCategories = [
  {
    ...
    items: [
      ...
      { label: "快速入门", articleId: "quick-start" },
      { label: "账号与角色", articleId: "account-roles" },
    ],
  },
  {
    title: "空间分析",
...
export const helpArticles: HelpArticle[] = [
  {
    ...
    title: "平台导览",
    summary:
      "面向首次使用者说明平台的整体结构、顶部导航和帮助中心组织方式，帮助用户理解各模块之间的关系。",
    ...
    blocks: [
      {
        ...
        title: "主要入口",
        items: [
          "地理数据：进入地图工作台，完成空间数据浏览、图层加载、属性查询和空间查询。",
          "非地理数据：查看表格、基因、分子和实验记录等非空间数据的统计视图与后续接入入口。",
          "数据管理：维护数据概览、存量数据、工程、专题和数据导入任务。",
          "后台管理：面向管理员提供运行概览、用户权限、日志、系统设置和数据备份能力。",
          "关于我们：集中呈现系统简介、团队介绍、成员信息、胡杨知识和帮助文档。",
        ],
      },
      {
        type: "note",
        title: "当前实现说明",
        body: "智能解译在顶部导航中作为预留入口展示，当前点击后提示尚未接入后端服务；非地理数据页以示例工作台和后续接入框架为主。",
      },
    ],
  },
  {
    ...
    title: "快速入门",
    summary:
      "用最短路径完成登录、数据浏览、空间查询和结果导出，适合普通用户和科研用户首次上手。",
    audiences: ["普通用户", "科研用户"],
    tags: ["首次登录", "数据浏览", "查询结果"],
    blocks: [
      {
    ...
    blocks: [
      {
        ...
        title: "典型角色",
        items: [
          "普通用户：浏览可见数据、加载图层、查看属性和阅读帮助内容。",
          "科研用户：在浏览基础上使用数据导入、结果导出、工程专题和科研工作台能力。",
          "数据管理员：维护存量数据、默认可视化、访问范围、工程和专题内容。",
          "系统管理员：管理用户、角色、系统配置、日志、备份和关键运维操作。",
        ],
      },
      {
        type: "note",
  ...
  },
  {
    ...
    blocks: [
      ...
      },
      {
        type: "note",
        title: "栅格渲染边界",
        body: "栅格文件的符号化和瓦片生成由后端完成，前端仅加载后端输出的影像或瓦片服务。",
      },
    ],
  },
  {
        ...
        items: [
          {
            title: "选择文件",
            description:
              "当前页面支持 CSV、XLS、XLSX 表格导入，以及 TIF、TIFF、IMG、VRT 栅格导入。",
          },
          {
            title: "填写资源信息",
            description:
              "补充名称、来源、提供单位、业务类型、数据日期、访问范围和说明信息。",
          },
          {
            title: "设置结构",
            description:
              "表格数据可导入为普通表或空间点表；空间点表需要配置经纬度字段与坐标系。",
          },
          {
            title: "提交并查看结果",
            description:
              "系统完成校验、入库或栅格预处理后，返回导入状态、错误信息和后续处理提示。",
          },
        ],
      },
      {
        type: "note",
        title: "矢量原始文件",
        body: "当前导入界面可识别矢量原始文件类型，但完整自动入库流程仍需按后续几何校验、字段映射和格式转换能力扩展。",
      },
    ],
  },
  {
    ...
    blocks: [
      ...
      },
      {
        type: "note",
        title: "删除确认",
        body: "删除资源属于敏感操作，界面会要求输入准确资源名称进行确认。删除前应确认备份与业务影响。",
      },
    ],
  },
  {
    ...
    blocks: [
      {
        ...
        items: [
          ...
          "系统设置：配置注册开关、查询限制、导出限制、数据根路径提示和运行参数。",
  ...
  },
  {
    ...
    blocks: [
      ...
      },
      {
        ...
        title: "安全建议",
        items: [
          "不要把业务数据根目录或研究数据根目录硬编码到前端或帮助文档中。",
...
export const helpFaq = [
  {
    question: "如何准备批量导入数据模板？",
    answer:
      "建议先确认数据类型、字段名称、字段含义、坐标系、时间范围和来源单位。空间点表必须包含经纬度或可映射为空间坐标的字段。",
  },
  {
    question: "空间查询没有结果时应如何排查？",
    answer:
      "先确认查询对象是可查询矢量资源，再检查绘制范围是否与资源空间范围相交；必要时缩小范围、切换坐标系或减少属性条件。",
  },
  {
    question: "非地理数据和地理数据如何关联？",
    answer:
      "优先使用样地编号、监测点编号、资源编号或统一业务主键关联。当前非地理数据页以示例工作台和后续接入框架为主。",
  },
  {
  ...
  },
  {
    ...
    answer:
      "可以。页面右上角提供 PDF 下载按钮，适用于培训、验收附件和离线阅读。若平台功能继续迭代，应同步更新 PDF 文件。",
  },
];
